...
public class ModItems {
   ...
   public static final Item ANIMATED_ITEM = registerItem("animated_item", new AnimatedItem(new Item.Settings()


           .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.PINK_GARNET, 30, -2.4f)
    ...
    public static final Item KIEM_GARNET_SWORD = registerItem("kiem_garnet_sword",
